...
function ruleStrLengthGreaterThanOne(objCalc, isPercent, tempResult) {
  const temp = objCalc;
...
function ruleStrLengthEqualsThanOne(objCalc, isPercent, tempResult) {
  const temp = objCalc;
...
function ruleStrEqualsThanZero(objCalc) {
  const temp = objCalc;
  ...
  function handleRulesDeleteLast() {
    ...
    switch (true) {
      case lastItem.length > 1:
        return ruleStrLengthGreaterThanOne(objCalc, isPercent, tempResult);
      case lastItem.length === 1 && lastItem === "0":
        return ruleStrEqualsThanZero(objCalc);
      case lastItem.length === 1:
        return ruleStrLengthEqualsThanOne(objCalc, isPercent, tempResult);
      default:
